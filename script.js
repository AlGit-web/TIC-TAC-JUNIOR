...
function logic(el) {
    ...
    b = document.getElementsByClassName("sel");
    v = [];
    for (i = 0; i < 9; i = i + 1) {
        v[i] = b[i].innerText;
    }
...
function bacel(a) {
    ...
    if (a == "X") {
        if (document.getElementById("player1").value == "") {
            document.getElementById("winName").innerText = '\n' + "Խաղը հաղթեց X խաղացողը "
        }
        else {

            document.getElementById("winName").innerText = "Խաղը հաղթեց"+document.getElementById("player1").value
        }
    }
    if (a == "O") {
        if (document.getElementById("player2").value == "") {
            ...
            document.getElementById("winName").innerText = "Խաղը հաղթեց"+document.getElementById("player2").value
        }


    }
    if (a == "XO") {
        document.getElementById("winName").innerText = "Ոչ Ոքի"
